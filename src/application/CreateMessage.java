...
public class CreateMessage {
    ...
    public void showQuestionReviewer(Stage primaryStage, User user, Question question, Review review) {
    	// Input fields for userName and password
    	Label messageLabel = new Label("Sending message to " + review.getAuthor());
        ...
        backButton.setOnAction(a ->{
        	try {
				new IndividualReviewPage(databaseHelper).show(primaryStage, user, question, review);
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
        ...
        setupButton.setOnAction(a -> {
        	...
        	String content = contentField.getText();
        	String sender = user.getUserName();
        	String receiver = review.getAuthor();
    ...
    public void showAnswerReviewer(Stage primaryStage, User user, Answer answer, Review review) {
    	// Input fields for userName and password
    	Label messageLabel = new Label("Sending message to " + review.getAuthor());
        ...
        backButton.setOnAction(a ->{
        	try {
				new IndividualReviewPage(databaseHelper).showAnswerReview(primaryStage, user, answer, review);
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
    ...
    public void showAnswerer(Stage primaryStage, User user, Question question, Answer answer) {
    	// Input fields for userName and password
    	Label messageLabel = new Label("Sending message to " + answer.getAuthor());
        ...
        setupButton.setOnAction(a -> {
        	...
        	String content = contentField.getText();
        	String sender = user.getUserName();
        	String receiver = answer.getAuthor();
