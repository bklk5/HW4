...
public class NewPasswordInterface {
	// These are the application values required by the user interface
	private Label label_ApplicationTitle = new Label("New Password Evaluation");
	private Label label_Password = new Label("Enter the new password here");
	 ...
	 */
	public NewPasswordInterface(Pane theRoot) {
		// Label theScene with the name of the testbed, centered at the top of the pane
		setupLabelUI(label_ApplicationTitle, "Arial", 24, NewPassword.WINDOW_WIDTH, Pos.CENTER, 0, 10);
				
		// Label the password input field with a title just above it, left aligned
		setupLabelUI(label_Password, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 10, 50);
		...
		setupTextUI(text_Password, "Arial", 18, NewPassword.WINDOW_WIDTH-20, Pos.BASELINE_LEFT, 10, 70, true);
		...
		setupLabelUI(noInputFound, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 10, 110);		
		...
		setupLabelUI(label_errPassword, "Arial", 14, NewPassword.WINDOW_WIDTH-150-10, Pos.BASELINE_LEFT, 22, 126);		
		...
		errPassword.setMinWidth(NewPassword.WINDOW_WIDTH-10); 
		...
		setupLabelUI(label_Requirements, "Arial", 16, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 10, 200);
		setupLabelUI(label_UpperCase, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 30, 230);
		label_UpperCase.setTextFill(Color.RED);
		label_LowerCase.setText("At least one lower case letter");

		setupLabelUI(label_LowerCase, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 30, 260);
		label_LowerCase.setTextFill(Color.RED);
			    
		setupLabelUI(label_NumericDigit, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 30, 290);
		label_NumericDigit.setTextFill(Color.RED);
			    
		setupLabelUI(label_SpecialChar, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 30, 320);
		label_SpecialChar.setTextFill(Color.RED);
			    
		setupLabelUI(label_LongEnough, "Arial", 14, NewPassword.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 30, 350);
		...
		setupLabelUI(validPassword, "Arial", 18, NewPassword.WINDOW_WIDTH-150-10, Pos.BASELINE_LEFT, 10, 380);				
		...
		theRoot.getChildren().addAll(label_ApplicationTitle, label_Password, text_Password, 
									noInputFound, label_errPassword, errPassword, errPasswordPart3, 
									validPassword, label_Requirements, label_UpperCase, label_LowerCase, 
